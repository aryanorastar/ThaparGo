...
const ThreeDMap: React.FC<ThreeDMapProps> = ({ onBuildingClick, selectedBuildingId }) => {
  ...
  const campusBuildings: Building[] = [
    ...
    { id: 'parking', name: 'Parking Area', position: [25, 0, 25], dimensions: [30, 1, 20], color: '#808080', rotation: Math.PI / 6 },
  ];
