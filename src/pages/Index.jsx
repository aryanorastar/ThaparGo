...
// NOTE seeding is now handled outside the production bundle. See scripts/useDatabaseSeed.ts if needed.
    ...
    <div className="container mx-auto px-4 py-8">
      {loading ? (
        <div className="flex justify-center items-center min-h-[60vh]">
          ...
          <motion.div 
            initial={{ opacity0, y-20 }}
            animate={{ opacity1, y0 }}
            transition={{ duration0.6 }}
          ...
          >
            {features.map((feature, index) => (
              <motion.div key={index} variant: s={item}>
                <Link to={feature.link}>
                  <Card className="h-full transition-all hover:shadow-lg hover:-translate-y-2 duration-300 border-2 hover:border-thapar-maroon/30">
                      ...
                      <motion.div 
                        className="mb-2"
                        whileHover={{ scale1.2 }}
                        transition={{ type"spring", stiffness400, damping10 }}
                      >
                        {feature.icon}
                      </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                <ul className="list-disc pl-5 space-y-2">
                  Find your way around campus with our interactive 3D map</li>
                  View your class schedules and locations</li>
                  Check classroom availability in real-time</li>
                  Book rooms for student society events and meetings</li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <ul className="list-disc pl-5 space-y-2">
                  Access teaching schedules and classroom assignments</li>
                  View and approve room booking requests</li>
                  Find appropriate classrooms based on capacity and equipment</li>
                  Navigate to different campus locations efficiently</li>
                </ul>
              </motion.div>
            </div>
          </motion.div>
