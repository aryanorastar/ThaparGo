...
import { idlFactory } from './thapar_go_assets.did.js';
export { idlFactory } from './thapar_go_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_THAPAR_GO_ASSETS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./thapar_go_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the thapar_go_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./thapar_go_assets.did.js")._SERVICE>}
 */
export const thapar_go_assets = createActor(canisterId);
